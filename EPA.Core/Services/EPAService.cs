...
namespace EPA.Services
{
    ...
    public class EPAService : EPA.Services.IEPAService  
    {
        ...
        public Dto.Models.COMPANY CompanyFetchById(int companyId)
        {
        ...
        public Dto.Models.COMPANY CompanyCreateByModel(Dto.Models.COMPANY company)
        {
        ...
        public Dto.Models.SUPPLIER SupplierCreateByModel(Dto.Models.SUPPLIER supplier)
        {
        ...
        public Dto.Models.COMPANY_USERS CompanyUserCreateByModel(Dto.Models.COMPANY_USERS companyUser)
        {
