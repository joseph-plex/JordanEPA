                    ...
                    case 1: //Create
                        {
                            ...
                            model = db.AssignPrimaryKey(model, (() => model.PRICE_AGREEMENT_ID), Data.Sequence.PRICE_AGREEMENT_ID);
                        ...
                        case 1: //create
                            {
                                ...
                                // model.PRICE_LIST_MATERIAL_ID = PriceAgreementMaterialIdGenerator();
                                model = db.AssignPrimaryKey(model, (() => model.PRICE_LIST_MATERIAL_ID), Data.Sequence.PRICE_LIST_MATERIAL_ID);
