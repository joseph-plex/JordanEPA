...
namespace EPA.Dto.Services
{
    ...
    public partial class ItemTypeFilter
    {
        public string IType { get; set; }
        public string ITypeGroup { get; set; }
    ...
    public partial class PriceAgreementIUDResponse
    {
    ...
    public partial class PriceAgreementIUDWrapper : EPA.Dto.Models.PRICE_AGREEMENT
    {
    ...
    public partial class PriceAgreementMaterialIUDWrapper : PRICE_AGREEMENT_MATERIALS
    {
        public int Operation { get; set; }
    ...
    public partial class PriceListIUDResponse
    {
    ...
    public partial class PriceListIUDWrapper : PRICE_LIST
    {
        public int Operation { get; set; }
    ...
    public partial class PriceListMaterialIUDWrapper : PRICE_LIST_MATERIALS
    {
        public int Operation { get; set; }
